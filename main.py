...
"""
Вот супер-удобный набор команд для лёгкого управления проектами! 😎 Используй их, чтобы быстро создавать, редактировать и просматривать задачи. 🎉

/new_project — добавь новый проект ✨🎊

/skills — выбери навык для проекта 🎯🔥

/projects — выведи список всех проектов 📋📊

/delete — удали ненужный проект 🗑️🚀

/update_projects — обнови или измени проект 🔄💡

Просто введи имя проекта, и получи всю информацию о нём! 📈😍""")
...
def skill_project(message, projects):
    ...
    if project_name not in projects:
        bot.send_message(message.chat.id, '''У тебя нет такого проекта, попробуй еще раз! 🚫🔙😊.
                         Выбери проект для которого нужно выбрать навык: 🎯📋''', reply_markup=gen_markup(projects))
        bot.register_next_step_handler(message, skill_project, projects=projects)
    else:
